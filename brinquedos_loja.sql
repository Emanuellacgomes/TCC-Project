...
--
-- Servidor: 127.0.0.1
-- Tempo de Geração: 10/11/2025 às 19h12min
...
(19, 'Boneca Minnie Patinadora com Sons - Elka - Disney', 'A Minnie adora patinar e passear com o Mickey! Aperte a estrelinha e ela fala frases. A Minnie tem patins e capacete para brincar e se divertir!', '149.99', 19, 'c63bae5ebdbe823bcd363d775f361e7dwebp', 1, 8),
...
(36, 'Brinquedo Clássico - Pogobol - Amarelo e Laranja', 'Descrição do produto\r\nMais um Clássico da Estrela está de volta, o divertido Pogobol! Você vai se divertir e de quebra gastar uma boa dose de energia brincando! Para brincar, é só apoiar os pés sobre o disco, empurrar o disco para baixo com os pés e começar a pular. O Pogobol pode ser usado por crianças acima de 05 anos, pesando até 70 kg.', '229.99', 21, '885fb4f5617ba1f8dba2ec73e38ecdfdwebp', 7, 2),
(37, 'Brinquedo Clássico - Pogobol - Roxo e Verde', 'Descrição do produto\r\nMais um Clássico da Estrela está de volta, o divertido Pogobol! Você vai se divertir e de quebra gastar uma boa dose de energia brincando! Para brincar, é só apoiar os pés sobre o disco, empurrar o disco para baixo com os pés e começar a pular. O Pogobol pode ser usado por crianças acima de 05 anos, pesando até 70 kg.', '229.99', 32, '10d6cc52957eefade7793209b5b2a2eewebp', 7, 2),
(38, 'Pogobol - Roxo e Amarelo - Estrela', '\r\nO divertido Pogobol da Estrela voltou! Você vai se divertir e de quebra gastar uma boa dose de energia brincando! Você vai pular muito com esse brinquedo!', '229.99', 0, 'a5638a07d4e14c81274b31971ea40cf1webp', 7, 2),
(39, 'Toalha Social - Barbie Esportes - Mattel', 'A diversão é garantida em todas as ideias com esse Toalha Social!', '249.99', 0, '6ccef81d641ee420067774dc7e36bab9webp', 7, 4),
(40, 'Hot Wheels Patinete Max Turbo Com Fumaça', 'Patinete com Fumaça da Fun Divirta-se é tudo isso e muito mais! À primeira vista parece um patinete comum com 3 rodas, desenhado para conferir mais estabilidade e equilíbrio ao passeio das crianças, mas não se deixe enganar! Aperte seus pequenos botões localizados na robusta prancha e veja o que acontece! Radicais faróis frontais se acendem, conferindo ao patinete um estilo único. Aperte mais um botão para acionar o irado modo turbo e suas turbinas traseiras vão soltar fumaça e piscar em diferentes cores. A fumaça é feita com a adição de água em um compartimento escondido. E não fica por ai! Dê impulso e suas rodas também se acenderão com luzes piscantes que param só quando o patinete está imóvel. Incrível, não é?! É o seu passeio mais radical! O guidão ainda tem regulagem de altura e pode ser dobrado para caber em qualquer lugar. Recarregável via USB. Idade recomendada: acima de 5 anos. Selo INMETRO: INNAC 02115-000.', '299.99', 0, '76fcc981d856984673fa37a4439119b5webp', 7, 11),
(42, 'Brinquedos de pelúcia da coleção Pokémon: Mew', 'Mergulhe no empolgante universo de Pokémon com nossa coleção de bichos de pelúcia colecionáveis. Esses bonecos de pelúcia encantadores capturam a essência do seu Pokémon favorito com detalhes encantadores e materiais de alta qualidade.', '63.90', 13, '597b0f1c49b2eed2a7804dac40896b37webp', 5, 11),
(43, 'Pelúcia Stitch Sentado com Colar de Flores - UN', 'Tamanho 80x56x41cm\r\nSeu amiguinho Stitch está de volta e agora com a nova coleção de pelúcias!', '1499.99', 3, '7ea4b9227c54cca6391d44088dff90a9webp', 5, 11),
(44, 'Pelúcia Creeper - Minecraft', 'Pelúcia Creeper - Minecraft 30cm\r\nO Clássico mob explosivo está aqui!', '114.99', 57, '4b2106c48419f8281532e2ab763d507bwebp', 5, 11),
(45, 'Brinquedo Estimulante para Bebês', 'Este brinquedo estimulará a diversão e a criatividade do seu bebê com suas cores e sons diferentes!\r\nO brinquedo possui diversas variações de cores dependendo da entrega e estoque.', '121.72', 23, '06024a9640c5eefe71913eb527de3176.jpg', 7, 11),
(46, 'Miniatura - Colecionável - Minnie - Sortidas', 'Os colecionáveis da Disney são demais! Com 4 temas diferentes, você pode colecionar e se divertir! São 5 miniaturas incríveis por tema: Toys Story, Frozen, Princesas e Minnie! Leve Minnie, Mickey e Margarida para casa hoje! Cada embalagem contém apenas 1 Minnie (unitário) que pode variar a cor e o modelo. Atenção: O produto é sortido, as cores e os modelos podem variar de acordo com estoque! Não é possível escolher a cor ou modelo do produto. EMBALAGEM UNITÁRIA.', '39.99', 45, 'c484f12b1809d8f87e962bd41781bf6bwebp', 6, 9),
(47, 'Miniatura Colecionável - Stitch - Aloha - Disney', 'Leve para casa toda a diversão e travessuras do Stitch com essa Miniatura Colecionável Oficial! Inspirada no adorável experimento 626 da Disney, essa peça traz detalhes incríveis que capturam sua personalidade única. - Design autêntico: Expressão fiel e acabamento impecável para um visual encantador. - Tamanho ideal: Compacta e perfeita para decorar sua estante, mesa ou coleção. - Presente perfeito: Para fãs de Lilo & Stitch, colecionadores da Disney ou qualquer um apaixonado por esse alienígena travesso! Adote o Stitch e leve um toque de aventura e fofura para o seu dia a dia!', '39.99', 43, 'dc2040fb449d3d6df48d9eac4dadc8a2webp', 6, 9),
(48, 'Miniatura Colecionável - Carros - Relâmpago McQuen', 'Descrição do produto\r\nAcelere para o mundo de Radiator Springs com a Miniatura Colecionável de Carros! Inspirada na icônica animação da Disney Pixar, essa peça detalhada traz todo o charme e personalidade dos personagens mais velozes das telonas. - Detalhes impressionantes: Pintura fiel e acabamento impecável para uma reprodução autêntica. - Tamanho ideal: Perfeita para exibir em prateleiras, mesas ou completar sua coleção de miniaturas. - Presente perfeito: Para fãs de Carros, colecionadores de miniaturas e apaixonados por velocidade! Prepare-se para a corrida e leve para casa a emoção das pistas com essa miniatura incrível!', '39.99', 58, 'aa3f6aa15a258a5ce4d8e1ce757d7f03webp', 4, 9);
...
CREATE TABLE IF NOT EXISTS `descontos_cep` (
  `cep_prefixo` varchar(9) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pedidos` (
  ...
  `status_pagamento` varchar(50) CHARACTER SET latin1 NOT NULL,
  `id_transacao_mp` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
...
(104, 6, '2025-11-08 20:57:30', '57.50', 'aprovado', '132453068717');
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `senha` varchar(12) CHARACTER SET latin1 NOT NULL,
  `tipo` varchar(20) CHARACTER SET latin1 NOT NULL DEFAULT 'cliente',
  PRIMARY KEY (`codigo`),
